const {
  GetPartyRequest,
  GetPartyResponse,
} = require("@anzx/fabricapis-selfservice/fabric/service/selfservice/v1alpha4/self_service_api_pb");
const {
  PartyAPIClient,
} = require("@anzx/fabricapis-selfservice/fabric/service/selfservice/v1alpha4/self_service_api_grpc_web_pb");
...
setTimeout(() => {
  document.getElementById("try-kevin").onclick = () => {getData(USERS.kevin)};
  document.getElementById("try-wendy").onclick = () => {getData(USERS.wendy)};
}, 1000);
